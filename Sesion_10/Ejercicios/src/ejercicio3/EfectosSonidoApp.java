...
public class EfectosSonidoApp extends JFrame {
    ...
    private static final String WAV_APLAUSOS = "aplausos.wav";  // p.ej. "assets/aplausos.wav"
    private static final String WAV_CAMPANA  = "campana.wav";   // p.ej. "assets/campana.wav"
    private static final String WAV_EXPLOSION= "explosion.wav"; // p.ej. "assets/explosion.wav"
